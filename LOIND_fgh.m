function [ keypoint,descriptor ] = LOIND_fgh( rgbImage,depthImage,normals,pcloud,kinect_map )

img_gray=rgb2gray(rgbImage);
img_gray=imadjust(img_gray);
I=single(img_gray);
[feature,~,info]=vl_covdet(I,'Method','MultiscaleHarris','PeakThreshold',1000,'EdgeThreshold',10);
...
GrayImage=filter2(gaussian,img_gray);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
